...
import {
    ...
    CodingIcons,
    DesignIcons,
    EngLogo, FinishRightIcon,
    LaptopIcons, OnlineCourseIcons, OnlineLearningIcons, OnlineStudentIcons,
    PersonIcons,
    PrintIcons, RightLineIcons,
...
export const howItWorks = [
    { title: 'how_it_works_first_step', icon: OnlineCourseIcons },
    { title: '', icon: RightLineIcons },
    { title: 'how_it_works_second_step', icon: OnlineLearningIcons },
    { title: '', icon: FinishRightIcon },
    { title: 'how_it_works_third_step', icon: OnlineStudentIcons },
];
